...
void MainGame::initSystems()
{
	...
	mesh2.loadModel("D:\\git\\GP2-Coursework\\res\\monkey3.obj");
	
	texture.init("D:\\git\\GP2-Coursework\\res\\bricks.jpg"); //
	shader.init("D:\\git\\GP2-Coursework\\res\\shader"); //new shader
